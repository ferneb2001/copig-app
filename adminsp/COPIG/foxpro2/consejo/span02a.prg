...
* A no profesionales comunicando falta cumplim.s/nota    
...
*                 ?
                  ...
                  ?'del Ministerio de Ambiente y Obras P£blicas y  Reparticiones Centralizadas,'
                  ?'por DEPARTAMENTO ADMINISTRATIVO notif¡quese al (a la):                     '
                  ?chr(27)+chr(71)
                  ?? wnomtit at 4
                  ?? ' '
                  ?? nombre
...
*                  ?? wcateg pict 'XX'
                  ...
                  ?'ci¢n proceda a matricularse en este Consejo Profesional, por encontrarse en'
                  ...
                  ?'Art.3ø'
                  ??CHR(27)+CHR(45)+'0'
                  ??' (Decreto Ley 3485/63): Para ejercer las profesiones sujetas al presente  Decreto  Ley se requiere:  a) Poseer t¡tulo expe-'
                  ?'dido por Universidad Nacional o Universidad Privada, debidamente habilitada por los organismos competentes del Estado o expedido '
                  ?'por Universidad Extranjera revalidado por Universidad Nacional o por tratado de reciprocidad o equivalencia o lo que en el futuro'
                  ?'fije para los pa¡ses integrantes del Mercosur; b) Estar  Matriculado en el Registro  Oficial a  cargo del Consejo Profesional que'
                  ?'crea este Decreto - Ley; c) Renovar anualmente la inscripci¢n, fijando domicilio legal dentro de la provincia".------------------'
                  ??CHR(27)+CHR(45)+'1'
                  ?'Art.7ø'
                  ??CHR(27)+CHR(45)+'0'
