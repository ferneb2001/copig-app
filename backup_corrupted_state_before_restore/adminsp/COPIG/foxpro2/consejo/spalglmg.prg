procedure spalglmg
*Genera archivo sptlma y sptlmas para La Mercantil Andina
...
*      use spmatri
      ...
      *@12,01 clear to 12,78       
      ...
      if wdpto=0 .and. wtitulo='   ' 
         sort to sptlmas  on titulo, nombre 
      else   
         if wdpto<>0 .and. wtitulo='   '
            sort to sptlmas  on titulo, nombre
         else
...
*endif
wop1=1   
IF a.titulo='083' or a.titulo='089' or a.titulo='212'
	wop1=0
*else
*	IF a.titulo='705' or a.titulo='801' or a.titulo='901' or a.titulo='902' or a.titulo='903'
*		wop1=1
*	else
*		IF a.titulo='904' or a.titulo='923' or a.titulo='H01' or a.titulo='H03' or a.titulo='H04'
*			wop1=1
*		else
*			IF a.titulo='H05' or a.titulo='H07' or a.titulo='N01' or a.titulo='N02' or a.titulo='N04'
*				wop1=1
*			else
*				IF a.titulo='P01' or a.titulo='Q01'
*					wop1=1
*				ENDIF
*			endif
*		endif
