/**
 * ANÁLISIS DE SPTLMUS.DBF
 * Posible archivo de empresas para mapeo
 */

const Parser = require('node-dbf').default;

async function analizarSPTLMUS() {
    console.log('═══════════════════════════════════════════════════════════════');
    console.log('📊 ANÁLISIS DE SPTLMUS.DBF (Posibles Empresas)');
    console.log('═══════════════════════════════════════════════════════════════\n');
    
    const archivo = 'C:\\copig-app\\adminsp\\COPIG\\SPTLMUS.DBF';
    ...
    parser.on('record', (record) => {
        ...
        // Buscar IMPSA (ID 1 en nuestra BD)
